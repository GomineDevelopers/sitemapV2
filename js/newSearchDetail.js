    ...
    mounted: function() {
        ...
        axios
            ...
            .then(function(response) {
                ...
                self.intro.latitude=response.data.data.lat==null?temp:response.data.data.lat;
                self.intro.longitude=response.data.data.lng==null?temp:response.data.data.lng;
